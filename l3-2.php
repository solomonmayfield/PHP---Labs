...
//ballplayer2.php - demonstrates static members (properties & methods)

$playerArray = array(); //create an empty array
$playerArray[] = new BallPlayer("Babe Ruth","NYY",23); //load it with BallPlayers
...
print "They average: " . BallPlayer::averageHomers() . " homers per player.<br />";
print "Here are the players: <br />";
foreach($playerArray as $player)
{
	print $player->toString() . "<br />";	 
}
...
class BallPlayer
{//a class for storing baseball player data

	
	//public static properties store aggregate data 
	private static $TotalHomers = 0; //Will Store Total Homers
	private static $TotalPlayers = 0; //Will Store Total BallPlayers
	
	//fields are all private now so that acessors allow access
	private $name = '';  
 	private $team = '';
